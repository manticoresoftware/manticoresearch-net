    ...
    public partial class IndexApi : IDisposable, IIndexApi
    {
        ...
        public ManticoreSearch.Client.ApiResponse<UpdateResponse> PartialReplaceWithHttpInfo(string table, int id, ReplaceDocumentRequest replaceDocumentRequest)
        {
            ...
            if (replaceDocumentRequest == null)
                throw new ManticoreSearch.Client.ApiException(400, "Missing required parameter 'replaceDocumentRequest' when calling IndexApi->PartialReplace");
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PartialReplace", localVarResponse);
                if (_exception != null) throw _exception;
            }
