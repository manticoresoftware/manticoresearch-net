...
${nuget_cmd} install src/ManticoreSearch/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ManticoreSearch.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ManticoreSearch.dll \
-recurse:'src/ManticoreSearch/*.cs' \
-doc:bin/ManticoreSearch.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ManticoreSearch.dll was created successfully"
fi
